...
class TelcoFeatureEngineer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X: pd.DataFrame) -> pd.DataFrame:
        ...
        # 1. Service Count (Service Density)
        ...
        # 2. Charge Velocity / Ratio
        if "MonthlyCharges" in X_df.columns and "TotalCharges" in X_df.columns:
            # Add epsilon 1.0 to denominator to prevent division by zero
        ...
        # 4. High Risk Combination (Month-to-month contract + Electronic check)
