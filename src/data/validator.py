...
# Core essential columns strictly required for churn risk scoring
...
def validate_and_align_dataset(
    ...
    # 1. Map columns using alias lookup
    ...
    # 2. Check for core mandatory columns
    ...
    # 3. Handle optional missing features from ALL_FEATURES
    ...
    # 5. Clean customerID or create placeholder index
